...
class TsiAPIBatch {
  constructor(api, dataProvider, options) {
    ...
    this.handler = new TsiAPIDefaultHandler();
  ...
  stop() {
    ...
    this.logger.info("First request at: " + this.handler.statistics.firstRequestAt);
    this.logger.info("Last responce at: " + this.handler.statistics.lastResponceAt);
    this.logger.info("Number of Requests: " + this.handler.statistics.numberOfRequests);
    this.logger.info("Number of Responces: " + this.handler.statistics.numberOfResponces);
    this.logger.info("Number of Errors: " + this.handler.statistics.numberOfErrors);
    this.logger.info("Number of Fatal Errors: " + this.handler.statistics.numberOfFatalErrors);
    this.logger.info("Avg Responces / sec: " + 1000 / (this.handler.statistics.lastResponceAt - this.handler.statistics.firstRequestAt) * this.handler.statistics.numberOfResponces);
  ...
  tick() {
    // selftune the ratio
    var backlog = this.handler.statistics.numberOfRequests - this.handler.statistics.numberOfResponces;
    if (backlog > this.max) {
    ...
    if (this.ticks % 10 == 0) {
      this.logger.info("requests: " + this.handler.statistics.numberOfRequests +
        " responces: " + this.handler.statistics.numberOfResponces +
        " backlog: " + backlog +
        " ratio: " + this.ratio +
